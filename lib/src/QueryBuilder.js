...
var QueryBuilder = /** @class */ (function () {
    ...
    QueryBuilder.prototype.whereEqualTo = function (prop, val) {
        this.queries.push({
    ...
    QueryBuilder.prototype.offset = function (offsetVal) {
        if (this.offsetVal) {
    ...
    QueryBuilder.prototype.findOne = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.executor.execute(this.queries, this.limitVal, this.offsetVal, this.orderByObj, true)];
                    case 1:
                        queryResult = _a.sent();
