...
var TransactionRepository = /** @class */ (function (_super) {
    ...
    TransactionRepository.prototype.findById = function (id) {
        var query = this.collection.doc(id);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        doc = item.id ? this.collection.doc(item.id) : this.collection.doc();
                        if (!item.id) {
                            item.id = doc.id;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        query = this.collection.doc(item.id);
    ...
    TransactionRepository.prototype.set = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        query = this.collection.doc(item.id);
                        return [4 /*yield*/, this.transaction.set(query, this.toSerializableObject(item))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, item];
                }
    ...
    TransactionRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transaction.delete(this.collection.doc(id))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TransactionRepository.prototype.getReference = function (id) {
